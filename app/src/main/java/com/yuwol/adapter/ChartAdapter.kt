...
import com.yuwol.databinding.ListItemChartBinding
...
class ChartAdapter : RecyclerView.Adapter<ChartAdapter.ViewHolder>() {
    ...
    val chartList = mutableListOf<Chart>()
    ...
    class ViewHolder(private val binding: ListItemChartBinding) : RecyclerView.ViewHolder(binding.root){
